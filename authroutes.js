...
const { newId, newAccountNumber, newOtpCode, now } = require('./helpers');
...
router.post('/register', async (req, res) => {
  ...
  try {
    ...
    res.status(201).json({
      ...
      account: { id: result.account.id, accountNumber: result.account.accountNumber, balance: result.account.balance },
